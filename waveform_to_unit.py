...
''' Convert waveform to neural audio codec (speech unit). '''
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("-s", "--splits", nargs="*", default=["test"])
    parser.add_argument("-o", "--output_dir", type=str, default="./data/soxdata_encodec")
